...
BreakpointAction ==
    \* TODO: Implement breakpoint action  
    TRUE
...
CheckpointCrashAction ==
    \* TODO: Implement checkpoint crash action
    TRUE

CommitTransactionAction ==
    \* TODO: Implement commit transaction action
    TRUE

CrashAction ==
    \* TODO: Implement crash action
    TRUE

CreateTableAction ==
    \* TODO: Implement create table action
    TRUE
...
PrepareTransactionAction ==
    \* TODO: Implement prepare transaction action
    TRUE
...
RollbackToStableAction ==
    \* TODO: Implement rollback to stable action
    TRUE

RollbackTransactionAction ==
    \* TODO: Implement rollback transaction action
    TRUE

SetCommitTimestampAction ==
    \* TODO: Implement set commit timestamp action
    TRUE

SetOldestTimestampAction ==
    \* TODO: Implement set oldest timestamp action
    TRUE

SetStableTimestampAction ==
    \* TODO: Implement set stable timestamp action
    TRUE
...
WTConfigAction ==
    \* TODO: Implement WT config action
    TRUE
